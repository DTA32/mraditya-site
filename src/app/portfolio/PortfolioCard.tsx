...
function PortfolioImage(props: PortfolioCardProps) {
  if (props.image) {
    return (
      <Image
  ...
  return (
    <p className="flex aspect-square w-1/4 bg-slate-700 text-neutral-300 rounded-l-lg justify-center items-center text-center">
...
export default function PortfolioCard(props: PortfolioCardProps) {
  return (
    <div className="flex w-full h-full group aspect-square relative hover:scale-105 ease-in-out duration-300 bg-slate-900 rounded-lg overflow-hidden">
